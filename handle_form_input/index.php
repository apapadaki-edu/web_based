...
function listCountries($countryFile){
                                ...
                                <form method="post" action="verify.php">
                                    <fieldset id="account">
                                        ...
                                        <div class="fieldItem">
                                            ...
                                            <input type="password" id="rpassword" name="rpassword" placeholder="At least 8 characters" minlength="8">
                                        </div>
                                    </fieldset>
                                    <fieldset id="profile">
                                        ...
                                        <div class="fieldItem">
                                            ...
                                            <input type="text" id="fname" name="fname" pattern="^[A-Za-z][A-Za-z\.\- ]+[A-Za-z]$">
                                        </div>
                                        <div class="fieldItem">
                                            <label for="lname">Last Name</label>
                                            <input type="text" id="lname" name="lname" pattern="^[A-Za-z][A-Za-z\.\- ]+[A-Za-z]$">
                                        </div>
                                        <div class="fieldItem">
                                    ...
                                    <fieldset id="contact">
                                        ...
                                        <div class="fieldItem">
                                            ...
                                            <input type="text" id="city" name="city" pattern="^[A-Za-z][A-Za-z]+[A-Za-z]$">
                                        </div>
                                        <div class="fieldItem">
                                            <label for="zip">Zip</label>
                                            <input type="text" id="zip" name="zip" max="8" pattern="^\d[\d ]{3}\d$">
                                        </div>
                                        <div class="fieldItem">
                                            <label for="country">Country</label>
                                            <select id="country" name="country">
                                                <?php 
                                                    listCountries("countries.txt")
                                                ?>
                                            </select>
                                        </div>
                                        <div class="fieldItem">
                                            <label for="mobile">Phone</label>
                                            <input type="tel" id="phone" name="phone" placeholder="NNN-NNN-NNNN" pattern="^\d{3}\-\d{3}\-\d{4}$" required>
                                        </div>
                                    </fieldset>
                                    <div id=termsField>
